 ...
 */
public class StartListeningToPredictionsMessage extends Message {
    ...
    public StartListeningToPredictionsMessage(String src, PreXException exception, PredictionContext context) {
        super(src);
